...
//            hints.put(EncodeHintType.MARGIN, 2); //default is 4  
    ...
    public static Bitmap createImage(Context context, String codeFormat, ImageView codeImg) {
        try {
            if (codeFormat == null || "".equals(codeFormat) || codeFormat.length() < 1) {
                ...
                hints.put(EncodeHintType.CHARACTER_SET, "utf-8");
                int QR_WIDTH = context.getResources().getDimensionPixelSize(R.dimen.qr_width);
                int QR_HEIGHT = context.getResources().getDimensionPixelSize(R.dimen.qr_height);
