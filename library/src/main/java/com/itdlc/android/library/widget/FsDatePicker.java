...
public class FsDatePicker extends LinearLayout {
    ...
    public FsDatePicker(Context context) {
        super(context);
        initDateTimePicker();
    }

    public FsDatePicker(Context context, AttributeSet attrs) {
        super(context, attrs);
        initDateTimePicker();
    }
    ...
    private void setDayByMonth() {
        ...
        if (list_big.contains(month_current + 1 + "")) {
            ...
            if ((year_current % 4 == 0 && year_current % 100 != 0)
                    || FsDatePicker.this.year_current % 400 == 0)
                day_actual = 29;
            else
                day_actual = 28;
        }
    ...
    public String getTimeString(String join) {
        return year_current + join + (month_current + 1) + join + day_current;
    }
